...
void c_skinchanger::run() noexcept {
	...
	config_system.item.knife_model = 2;
	config_system.item.paint_kit_index_knife = 40;
	config_system.item.knife_wear = 0;
	config_system.item.paint_kit_index_cz = 322;
	config_system.item.paint_kit_index_deagle = 37;
	config_system.item.paint_kit_index_duals = 747;
	config_system.item.paint_kit_index_fiveseven = 837;
	config_system.item.paint_kit_index_glock = 38;
	config_system.item.paint_kit_index_p2000 = 389;
	config_system.item.paint_kit_index_p250 = 102;
	config_system.item.paint_kit_index_revolver = 798;
	config_system.item.paint_kit_index_tec = 816;
	config_system.item.paint_kit_index_usp = 705;
	config_system.item.paint_kit_index_m249 = 547;
	config_system.item.paint_kit_index_mag7 = 703;
	config_system.item.paint_kit_index_negev = 514;
	config_system.item.paint_kit_index_nova = 716;
	config_system.item.paint_kit_index_sawoff = 638;
	config_system.item.paint_kit_index_xm1014 = 557;
	config_system.item.paint_kit_index_mac10 = 433;
	config_system.item.paint_kit_index_mp5sd = 810;
	config_system.item.paint_kit_index_mp7 = 696;
	config_system.item.paint_kit_index_mp9 = 39;
	config_system.item.paint_kit_index_p90 = 359;
	config_system.item.paint_kit_index_bizon = 508;
	config_system.item.paint_kit_index_ump45 = 802;
	config_system.item.paint_kit_index_ak47 = 380;
	config_system.item.paint_kit_index_aug = 455;
	config_system.item.paint_kit_index_awp = 344;
	config_system.item.paint_kit_index_famas = 604;
	config_system.item.paint_kit_index_g3sg1 = 606;
	config_system.item.paint_kit_index_galil = 265;
	config_system.item.paint_kit_index_m4a1 = 430;
	config_system.item.paint_kit_index_m4a4 = 309;
	config_system.item.paint_kit_index_scar = 597;
	config_system.item.paint_kit_index_sg553 = 613;
	config_system.item.paint_kit_index_ssg08 = 624;
